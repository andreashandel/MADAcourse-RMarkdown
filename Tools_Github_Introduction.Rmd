...
Once you have created your GitHub account, post your GitHub user name into the `GitHub topics` discussion group. Then you should be all set to start the first exercise of the course, where you will be using GitHub.
