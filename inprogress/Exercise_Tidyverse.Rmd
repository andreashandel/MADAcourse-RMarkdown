...
You previously did a project where you used base R code to do a simple data analysis. We will revisit this analysis but now will be using R packages from the tidyverse and more. We will use the Github workflow, with some additional twists to learn a bit more about Github functionality.
...
# Getting help
* Use any online source you want. Also, feel free to push your project with the error message to Github, then post on the discussion board a description of your problem with a link to your file, so others can see what isn't working and can help better.