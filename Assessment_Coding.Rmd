...
If you use functions from various packages, it is good practice to load all packages at the beginning of your code. This way, it is 

So if you are using some R package for the tasks I just described, instead of loading it (with `library` just before you use it, place all your `library` commands at the beginning of your script. Also, add a short comment explaining why you are loading a certain package.)
:::
