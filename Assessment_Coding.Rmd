...
Once everyone has done their part (by Wednesday at the latest), you'll contribute to another group member's project. Earlier, we did collaborative work by having individuals added as collaborators for a repository. There are other ways, we'll try a different one here, called the "fork and pull-request" workflow. You'll be using that multiple times throughout this class. Find the repository of the team member you will contribute to and `Fork` their repository.
