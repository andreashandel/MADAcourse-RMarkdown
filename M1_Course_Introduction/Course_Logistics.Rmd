---
title: EPID 8060 Fall 2019 - Course Introduction 
author:
  name: Andreas Handel
...
output:
  html_document:
    ...
    includes:
      ...
      before_body: ../styles/before_body.txt
      after_body: ../styles/after_body.txt 
  pdf_document:
    toc: true
    mathjax: null
---
...
## Overview
* This first unit (which in this course I call modules) provides an overview of the whole course logistics and setup, followed by an overall introduction to the topic and a motivating example.
...
Do a pre-course quiz to assess knowledge.
