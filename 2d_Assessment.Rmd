...
This module got you started with all the important tools. Let's try to apply it in a small but also comprehensive exercise. For this module, you need to do a small project that shows you have R/Studio/Rmarkdown and Github running and it will also introduce you to your classmates.
