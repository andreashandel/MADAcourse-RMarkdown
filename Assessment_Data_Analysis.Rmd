...
The person your group designated as __project owner__ should do the following: Go ahead and start another repository using the template. Name it `GROUPN-MADA-analysis1` (with N of course your group number). Next, find the repository on your GitHub page, go into `Settings -> Manage Access` and use the `Invite Collaborator` button to add the other group members to the repository. You need to give them write access. Your group members need to accept the invitation.
