...
The [RStudio Keras website](https://keras.rstudio.com/index.html) has a lot of good information, and also provides links to further resources. Starting there with the _Tutorials_ section is probably the best way to get going. After that you can branch out to some of the listed resources (e.g. the _Learn_ section on that website). Making use of the _Keras_ website and resources mentioned there, will get you far.
