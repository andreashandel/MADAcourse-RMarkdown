...
The following way of categorizing types of data analyses follows [_The Art of Data Science (ADS)_](https://leanpub.com/artofdatascience) - specifically, chapter 3, which now might be a good time to re-read.
...
For some additional (as well as overlapping) information to what I wrote, read [Chapters 1 and 2.1. _An Introduction to Statistical Learning_ (ILS)](http://faculty.marshall.usc.edu/gareth-james/ISL/), as well as  [chapters 22-23 (24 optional) of _R for Data Science_ (R4DS)](http://r4ds.had.co.nz/index.html). **I will cover that content in the quiz.** 
