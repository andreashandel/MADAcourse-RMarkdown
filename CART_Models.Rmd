...
```{r treeexample1,  fig.show='hold', fig.cap='[From this paper](https://doi.org/10.1093/fampra/cms020)', out.width='400px', echo=FALSE, fig.align='center'}
knitr::include_graphics("./media/afonso12.png")
```

As you can see, this is a very simple model that is very intuitive and could be easily understood by physicians and other laypeople. The tree is used here for classification, with an outcome that binary (presence/absence of flu).


The next example is a tree used for a regression problem to predict/model a continuous outcome.

```{r treeexample2,  fig.show='hold', fig.cap='[From this paper](https://clincancerres.aacrjournals.org/content/5/11/3403)', echo=FALSE, fig.align='center'}
