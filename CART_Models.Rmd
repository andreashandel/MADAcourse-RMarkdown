...
where _T_ is the number of leaves of the tree. More leaves means a larger tree, which is being penalized. The tuning parameter $\lambda$ needs to be determined using parameter tuning or model training.
