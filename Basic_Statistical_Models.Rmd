...
```{r kmeans,  echo=FALSE, fig.cap='Choosing K is an important task. 3 sometimes works. Source: xkcd.com.', out.width = '50%', fig.align='center'}
knitr::include_graphics("./media/xkcd_k_means_clustering_2x.png")
```
