...
# Getting help
* If you get stuck (quite possible), use the venues I list in the _Resources_ document. Probably best to first post on the discussion board (in the _Introducing Ourselves_ section, I'll be checking it frequently). You can also use other ways to get help (Google, R4Ds Slack channel, colleagues/friends/relatives with R/Markdown experience, etc.). Still, try to do as much as possible yourself. We'll use all the bits you are learning here repeatedly. 
