...
```{r open science, echo=FALSE, out.width = '40%', fig.align='center', fig.cap='', fig.alt="A circular graphic with 'open science' in the center, showing several components of open science around it ([source](https://www.earthdata.nasa.gov/esds/open-science/oss-for-eso-workshops))."}
