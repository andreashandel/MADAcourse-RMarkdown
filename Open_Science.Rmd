...
```{r open science, echo=FALSE, out.width = '40%', fig.align='center', fig.cap='Open science is like spaghetti sauce--it has a lot of ingredients that have to be cooked together to get the best flavor.', fig.alt="A circular graphic with 'open science' in the center, showing several components of open science around it ([source](https://www.earthdata.nasa.gov/esds/open-science/oss-for-eso-workshops))."}
