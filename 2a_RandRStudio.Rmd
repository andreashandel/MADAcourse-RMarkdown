...
# Overview
This is a very quick introduction to R and RStudio, to get you set up and running. In the next module, we'll go deeper into R and coding.
...
* If you haven't already, [install R first](https://www.r-project.org/). You can pick any mirror you like. If you already have R installed, make sure it is a fairly recent version. I suggest version 3.5 or newer. If yours is older, I suggest you update (install a new R version).
