...
```{r comic,  echo=FALSE, fig.cap='', out.width = '50%', fig.align='center',fig.alt="A comic of two scientists standing in front of a lab bench that has electrophoresis gel printouts scattered on it. One says to the other 'Data don't make any sense, we will have to resort to statistics.'"}
knitr::include_graphics("./media/vadlo_statistics.png")
```
