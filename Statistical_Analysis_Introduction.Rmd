...
```{r workflow,  echo=FALSE, fig.cap='Maybe Dogbert did not do the analysis quite right. Source: dilbert.com.', out.width = '60%', fig.align='center', fig.alt='A three panel Dilbert comic. In the first panel, Dilberts boss says "Our consultant has been mining data all day" and Dogbert responses "The results are quite shocking." In the middle panel, Dilberts boss says "According to the data, sales are always highest when I do this...", and in the final panel, Dilberts boss makes a funny face.'}
