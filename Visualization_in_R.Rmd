...
If you are new to ggplot2, a good and gentle introduction is the set of tutorials in the [_Visualize Data_ RStudio Primer section](https://rstudio.cloud/learn/primers/3). Similar material, though a little bit more advanced, is covered in a non-interactive form in the _Data Visualization_, _Exploratory Data Analysis_ and _Graphics for Communication_ chapters [of R4DS](http://r4ds.had.co.nz/). Another good source are the chapters in the _Data Visualization_ section [of IDS](https://rafalab.github.io/dsbook/). If you want to learn a bit more about `ggplot2` in general, the ideas behind it, and also how to use it, you can check out Hadley's free online [ggplot2 book](https://ggplot2-book.org/). I suggest you go through some of those materials and focus on the ones you find most useful. 
