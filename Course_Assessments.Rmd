...
**The link to the website for quiz submission is pinned to the _announcements_ Slack channel. Before submitting any quizzes, you need to set up a password by filling the Google Form that was shared with you in the welcome email.**
...
For each module, you are asked to fill out an Excel sheet with questions related to the course material. Download the quiz files from the links below, fill in the `Answer`" column, and submit to the online quiz submission system by the deadline specified in the __Schedule__ document.
...
_Quizzes will become available here as the course progresses. Once a quiz is available, you should be able to submit it at any time before the deadline._
...
<!-- * [Module 8 – Fitting basic statistical models](./quizsheets/mada_basic_statistical_models_student.xlsx) -->
<!-- * [Module 9 – Evaluating your model fits](./quizsheets/mada_model_evaluation_student.xlsx) -->
<!-- * [Module 10 – Improving your model fits](./quizsheets/mada_model_improvement_student.xlsx) -->
<!-- * [Module 11 – Machine Learning Models I](./quizsheets/mada_ml_models_1_student.xlsx) -->
<!-- * [Module 12 – Machine Learning Models II](./quizsheets/mada_ml_models_2_student.xlsx) -->
<!-- * [Module 13 – The complete analysis workflow](./quizsheets/mada_full_workflow_student.xlsx) -->
...
* Make meaningful contributions. You are welcome to react to each others' posts with `r emoji::emoji("smiley")` or `r emoji::emoji("thumbs up")`, but that does not replace more substantial responses. Give reasons why you think something is one way or another.
