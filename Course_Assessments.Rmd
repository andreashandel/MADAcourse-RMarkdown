...
**Unless otherwise specified, you can submit each quiz once, and it needs to be submitted by the deadline (generally Friday 5pm), otherwise the sytem will not take your submission.**
...
__Unless otherwise specified, exercises are due by Friday 5pm. Quite often, some part of the exercise needs to be done before that deadline to allow for group work.__ 
...
__Unless otherwise specified, the first posting of the discussion is due by Wednesday, the discussion replies are due by Friday 5pm. Post to the discussion channel for the applicable module (e.g. module2_discussion, module3_discussion).__ 
