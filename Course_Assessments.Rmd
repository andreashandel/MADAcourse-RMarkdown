...
**Before submitting any quizzes, you need to set up a password using the Google Form that was shared with you in the welcome email.**
...
For each module, you are asked to fill out an Excel sheet with questions related to the course material. Download the quiz files from the links below, fill in the "Answer" column, and submit to an online quiz submission system by the deadline specified in the __Schedule__ document.


**The link to the website for quiz submission is pinned to the _announcements_ Slack channel.**

Unless otherwise noted, you have one submission attempt. For the first module, you have 2 attempts. This allows you to get used to the submission system.
...
__Quizzes will become available here as the course progresses.__
