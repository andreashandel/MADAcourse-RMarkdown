...
* [R for Data Science community](https://www.rfordatasci.com/) - an online community that tries to provide newcomer friendly help. They use Slack to communicate, you can join for free and ask questions.
* The discussion boards on eLC. Use them widely to ask questions, to answer others' questions, to post links to interesting resources, etc.
...
* The course materials website (this one) is a public Github repository. If you are curious, [you can look at all the files that make up this website](https://github.com/andreashandel/MADAcourse).
