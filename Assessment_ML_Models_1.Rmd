...
Note that the 3 symptom severity factors are ordinal, with None < Mild < Moderate < Severe. We can code them as **ordered factors**. I want you to do that as practice. However, to deal with ordered factors in a statistical analysis, one needs special approaches and we won't actually do those. 
