...
As we discussed previously, if you have an outcome variable, your data is called **labeled data** and the methods you use are called **supervised** methods/models. Data with one (or several) outcome variable(s) are most common. But as previously discussed, sometimes you might have data without clear outcomes (**unlabeled data**) and you still want to determine if there is some pattern in your data. This calls for **unsupervised** methods. 
...
In some of your (bio)statistics classes, you likely came across a variety of statistical tests, e.g., t-test, 
