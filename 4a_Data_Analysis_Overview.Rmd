...
# Learning Objectives
*	Understand what broad types of analysis methods there are
*	Be able to choose the right analysis to your problem


## Repeat - types of data questions

### Doesn't need model fitting:
* Descriptive (always): What's the data about
* Exploratory (almost always): Looking for patterns
...
## Continuous modeling approaches - R practice
Get "ContinuousModels1.Rmd" and work through it.
...
## Categorical modeling approaches - R practice
Get "CategoricalModels1.Rmd" and work through it.
