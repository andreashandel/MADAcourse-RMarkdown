...
# Github setup
* Make sure you followed the setup steps described in [the Github document](./2b_Github.html), i.e. create a a Github account, have a Github client up and running, and have joined the class organization. 
