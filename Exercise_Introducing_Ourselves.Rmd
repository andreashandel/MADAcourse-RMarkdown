...
# Github setup
* Make sure you followed the setup steps described in [the Github document](./2b_Github.html), i.e. create a Github account, have a Github client up and running, and have joined the class organization. 
* Once you are part of the organization, go to [the website](https://github.com/epid8060fall2019) and create a new repository (press the green _New_ button) named _YOURNAME-introduction_. You can see mine in there, which is called _andreashandel-introduction_. You can leave the description empty. Choose if you want the repository to be private or public. Check the box _Initialize this repository with a README_. Set the _.gitignore_ option to `R`, and you can leave the license at _none_. Click "create repository".  
* Your new repopository should have opened. If not click on your new repository on [the website](https://github.com/epid8060fall2019). Go to _Settings_ in the top right. Under the _Options_ tab in settings, scroll down to _Github Pages_ and switch it to _master_ from _none_. Don't choose a theme. 
...
* If you want, feel free to get creative and include other things. You can play with RMarkdown if you wish to, e.g., you can try to include some tables or a video or whatever.
