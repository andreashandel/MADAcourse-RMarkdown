...
The _Course Resources_ page was becoming too large, so I decided to split things into two pages. The _Course Resources_ page lists materials directly related to and used/mentioned in the course. This page lists a lot of other data science resources that are not used or mentioned explicitly in the course, but that might be useful and interesting. Everything listed is related to the course (i.e. the resources focus on topics (Data Science/Stats/etc.) or approaches (R/GitHub/etc.) used in the course. There is of course way more material out there that I do not list.
