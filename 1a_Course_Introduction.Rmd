...
# Introduction
Welcome to the class Modern Applied Data Analysis (MADA)! The course is listed as EPID8060E/BIOS8060E. It doesn't matter if you are enrolled under the EPID or BIOS label. I will refer to the course as MADA or EPID8060 interchangably. I think on eLC it is loaded as BIOS8060E.
...
# Course Setup
* The course is split into modules, each with one or several units. Each module will usually be covered in a week. The [schedule document](./Course_Schedule.html) gives an outline. This schedule might change, so check frequently.
...
* The _Projects_ section on the website with information for the semester-long class project.
...
## Exercises
The exercises are part of a single module, and are due at the last day of the module. They are listed in the _Schedule_ and described in more detail in the _Exercises_ section. I will likely add further ones, so look out for updates. 
...
At times, I ask you to post specific assignments to the discussion boards, and reply to other posts. I also encourage general, continued participation on the discussion boards. This can take any form, such as asking questions, answering questions, posting links to interesting content, providing feedback, etc. The more, the better `r emo::ji('smile')`.
...
# Getting help
I do not expect you to figure it all out yourselves. You will get stuck, and are encouraged to seek help. I'll suggest specific places to get help, see also the _Resources_ page.
