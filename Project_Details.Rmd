...
_This part of your project will be assessed by some of your classmates. See the `Reviews` document for more details._
...
_An great project would be at the level of Brian McKay's paper example you checked out in the [Motivating Examples document](./Data_Analysis_Motivation.html), or one of the projects on the `Project Examples` page._ 
