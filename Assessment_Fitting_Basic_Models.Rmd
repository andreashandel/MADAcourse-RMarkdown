...
* Remove all variables that have _Score_ or _Total_ or _FluA_ or _FluB_ or _Dxname_ or _Activity_ in their name. Don't do this one by one, figure out how to use R commands that let you remove things in an efficient manner, using e.g., `contains()` or .
