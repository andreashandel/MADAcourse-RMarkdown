...
Since trees have a tendency to overfit, it is common to __regluarize__ them by including a penalty for tree size. For instance, if we were to minimize SSR/RMSE, we would add a penalty to the cost function, _C_, to get 
