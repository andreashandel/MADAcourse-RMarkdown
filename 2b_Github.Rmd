...
To get up and running, here are the steps I recommend you follow. Below are a few further details:  
...
If the quick install instructions are not detailed enough, follow these in [Jeny's paper]() or her great online book [happygitwithr](https://happygitwithr.com/). Note that if you install Gitkraken, you don't have to install Git, since Gitkraken has it. It might still be a good idea to install it in case you want to use Github from RStudio.
