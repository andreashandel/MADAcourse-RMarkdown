...
:::note
I mentioned this before in various places and it's a theme throughout the course, that unless data is collected and analyzed using pre-specified protocols (e.g., a clinical trial for FDA approval) it is almost always the case that scientists have so much flexibility during the data collection and analysis stages that p-values and similar statistical measures are meaningless. The [**Researcher's degress of freedom**](https://en.wikipedia.org/wiki/Researcher_degrees_of_freedom) is everywhere and essentially impossible to get rid of. [Here](https://pubmed.ncbi.nlm.nih.gov/22006061/) is a very interesting paper illustrating how this very common problem leads to nonsensical results. The study is a (fake) psychology study, but everything applies in general and it is easy to follow. I highly recommend checking it out. Another resource worth reading is [this paper](http://www.stat.columbia.edu/~gelman/research/unpublished/p_hacking.pdf) by [Andrew Gelman](http://www.stat.columbia.edu/~gelman/), who calls this phenomenon **The garden of forking paths**. And of course [this xkcd cartoon](https://xkcd.com/882/) is a classic and illustrates the problem clearly. 
