...
Thus, while it is an approach that's useful to know about, you might want to consider other methods at reducing overfitting first, e.g., the regularization we discuss next.
