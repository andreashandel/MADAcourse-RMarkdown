...
So I just explained in detail how subset selection works and what it tries to accomplish (make simpler models and prevent overfitting), and now I'm going to tell you to maybe avoid it `r emoji::emoji('facepalm')`?! 
