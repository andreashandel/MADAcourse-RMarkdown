...
The whole [R4DS book](https://r4ds.had.co.nz/) focuses on the early stages of data analysis, including exploration. There is even a chapter called _Exploratory Data Analysis (EDA)_. I like this sentence from the beginning of their chapter _EDA is not a formal process with a strict set of rules. More than anything, EDA is a state of mind._ That's a very good way to put it. Do browse through that chapter of R4DS, but of course the rest of the book also provides lots of useful information on that topic. The [Visualize Data R Studio Primer](https://rstudio.cloud/learn/primers/3) also has one short lesson on EDA, which is worth giving a brief check.
