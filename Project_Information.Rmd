...
Each assignment needs to be submitted in a fully reproducible form. You should create a Github repository which should contain all the files for your project. Name it `YOURNAME-MADA-project`. The preferred type is a public repository, if you have data that requires to be kept confidential, you can make it a private repository.
