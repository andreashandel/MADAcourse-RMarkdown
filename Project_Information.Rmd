...
The deadlines are listed in the __Schedule__ document (it's unlikely, but they might change, so keep checking that document).
...
* Your classmates will provide peer-review feedback on parts 3 and 5. Details on that is provided in the [Project Review document](./Project_Review.html). I will assess these _peer reviews_.
