...
Working with strings and text is a type of analysis that will continue to increase in importance, given the increasing data streams of that type. Thus, learning more about this topic is a good idea. [The _string processing_ chapter (25) of IDS](https://rafalab.github.io/dsbook/string-processing.html) contains further good material that is worth working through. (I won't as any quiz questions on that.)

A very powerful, and also very confusing way to deal with strings is to use what are called _regular expressions_. This concept applies to any programming language, not just R. Both the R4DS and IDS readings above cover this topic. A good source for additional information is [this write-up by Jenny Bryan](https://stat545.com/block022_regular-expression.html). If you are interested in doing full analyses of text data, the [`tidytext` R package](https://juliasilge.github.io/tidytext/) and the [Text mining with R book](https://www.tidytextmining.com/) are great resources. A short introduction to this topic is [The _text mining_ chapter (27) of IDS.](https://rafalab.github.io/dsbook/text-mining.html) (I won't as any quiz questions on that.)
