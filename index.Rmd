...
_**This site is currently undergoing revisions in preparation for the upcoming fall 2021 offering of the course. As long as you see this message, assume Some things are not correct.**_
...
The course is currently scheduled to be offered in fall 2021. While the course is running, some material might not be visible and will be unlocked as the course proceeds. At any other time, this website is continuously online, with small updates happening on an ongoing basis and larger updates every time I teach the course. 


# Website content

The __General Information__ section provides a class __Syllabus__ and a __Schedule__. The latter will likely be updated throughout the course, so check it regularly. The __Communication__ page provides information on how course communications are planned to happen.

The majority of the content is listed under the __Modules__ heading. Each module has several units in a drop-down/pop-out menu. Go through them based on the instructions in the __Schedule.__

The __Assessments__ section contains the assessments that go with each Module.
