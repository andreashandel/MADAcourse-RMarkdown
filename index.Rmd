...
_**The course is currently not running. The website will be updated throughout the semester. Things might change (though likely not by a whole lot). Visit/check regularly, especially the Schedule. Note the last update time above.**_


<!-- **This course website is currently being updated for spring 2023. As long as this message is shown, consider the current website outdated, things will change (though likely not by a whole lot).** -->

<!-- At this point, all materials are online and will remain so with likely only small updates happening on an ongoing basis and larger updates expected once the course runs again.  -->
