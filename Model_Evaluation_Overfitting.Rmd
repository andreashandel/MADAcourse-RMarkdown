...
In either case, what we want is a model that is generalizeable (also sometimes called _externally valid_), and that applies equally well to new and similar data beyond the data we already collected. 
...
[In this blog post](https://www.fharrell.com/post/split-val/), Frank Harrell discusses some of the potential caveats for using methods such as cross-validation.
