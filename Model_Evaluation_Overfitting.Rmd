...
We discussed how to evaluate the performance of a model. We went through the idea of defining a single numerical value (cost/objective function) and optimizing (usually minimizing) it to find the best model. There is however a very big caveat to this. The main point is: **It doesn't matter how well your model performs on the data that you used to build your model!**
