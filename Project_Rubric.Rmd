...
* All relevant previous files and documents. Of course, restructuring is ok as you go along.
* Any new relevant files that are needed to reproduce everything.
* Code and text describing the first few analyses. You can start with simple bivariate ones, looking for patterns between your outcome(s) and individal predictors of interest. Those will likely take the form of scatterplots or boxplots or 2x2 tables, with accompanying statistical model analysis.
...
* A complete report, written in structure like a research paper (Abstract/Introduction/Methods/Results/Discussion/Citations).
* Supplementary material/text, Rmd/R scripts, data, etc. as needed.
* bibtex file.
* Everything well documented.
* Instructions on how to reproduce all your results.
...
* Everything from part 4, with improvements/edits based on peer review feedback.
