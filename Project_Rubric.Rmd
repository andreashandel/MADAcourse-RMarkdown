...
| --- | --- | --- |
| Sufficient | Submission is complete or fairly complete, contains enough information to allow assessment of feasibility of proposed project | 3 |
| Somewhat insufficient | Most components are present, but noticeable gaps exist | 2 |
...
| **Category** | **Description**  | **Score** |
| --- | --- | --- |
| Sufficient | Submission is complete or fairly complete | 3 |
...
Check the [Project Review Template file](./rfiles/Project_Review_Template.Rmd) to see how this submission will be assessed by your peers. I will not grade this part but it will be assessed by your peers, as described in the [_Project Review_](./Project_Review.html) document.

_An excellent project would look similar to the Brian McKay's paper example you checked out in the [Motivating Examples document](./Data_Analysis_Motivation.html)_ 
...
* Everything from part 5, with improvements based on peer review feedback.
* You are allowed to make as little or as many improvements based on feedback from your classmates as you like. I will only look at this final product and grade it.

I will grade the final project using the same criteria your classmates used for peer-assessment. This will be graded on a 100 points scale and combined with the other project scores for a final overall project score.
