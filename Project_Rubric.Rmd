...
| Somewhat insufficient | Most components are present, but noticeable gaps exist | 75 |
| Not sufficient | Submission is rather incomplete, has major missing parts which does not allow assessment of feasibility of proposed project | 50 
...
| Somewhat insufficient | Submission is somewhat incomplete, parts missing or not reproducible| 75 |
...
| --- | --- | --- |
| Sufficient | Submission is complete or fairly complete | 100 |
| Somewhat insufficient | Submission is somewhat incomplete, minor parts missing or not reproducible| 75 |
| Insufficient | Submission is very incomplete, major parts missing or not reproducible| 50 |
| Absent | Everything or majority of submission is missing | 0 |
...
I will not grade this part but it will be assessed by your peers, as described in the [_Project Review_](./Project_Review.html) document.
...
Grading for this part will follow the same rubric used for peer-assessment, provided in the _Project Review_ document. 
