...
This course already covers a lot of material (maybe more than should be covered in a single semester `r `emoji::emoji('grin')`. Of course, there is much more in the area of data analysis that we were not able to cover.
