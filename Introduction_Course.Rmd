...
```{r datacartoon,  echo=FALSE, fig.cap="In this course, I randomly switch back and forth between singluar and plurar. Source: phdcomics.com.", out.width = '100%', fig.align='center'}
...
* This class is _open everything_. You can use the internet, AI, ask your classmates, myself and others, get help from wherever you can. I trust you will find the right balance of getting help when you need it while still putting in enough effort to experience real learning. 
...
* The course is split into modules. Each module will usually be covered in a week. The __Schedule__ document gives an outline. The schedule is 
not fully finalized and will change, so check frequently.
